...
describe("getAuthErrorMessage", () => {
  ...
  it("should return the correct message for auth/email-not-verified", () => {
    const error = new FirebaseError("auth/email-not-verified", "");
    expect(getAuthErrorMessage(error)).toBe(
      "Please verify your email before signing in. We sent a new verification email.",
    );
  });
