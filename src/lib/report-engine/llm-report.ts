...
function buildPrompt(findings: ReportFinding[], target: string): string {
  ...
  return `You are a professional cybersecurity report writer for an AI-powered penetration testing platform. The assessment was conducted entirely by AI security agents backed by human validation — do NOT mention manual testing, manual methodologies, or human testers in any section. This is an AI-driven assessment.

Given the following penetration test findings against ${target}, produce three distinct sections for the report.
